...
const VIEW_OPTIONS = [
  { value: 'dayGridMonth', label: '월', icon: 'ic:round-view-module' },
  { value: 'timeGridWeek', label: '주', icon: 'ic:round-view-week' },
  { value: 'timeGridDay', label: '일', icon: 'ic:round-view-day' },
  { value: 'listWeek', label: '하루일정', icon: 'ic:round-view-agenda' },
];
