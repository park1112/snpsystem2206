...
const CARDS = [
  {
    ...
    title: 'UI & UX Design',
    description: '깔끔하고 정돈된 UI & UX Design 으로 정확한 자료입력과 알기 쉬운 통계 이 모든것을 하나로 통합',
  },
  {
    icon: 'https://minimal-assets-api.vercel.app/assets/icons/ic_code.svg',
    title: '코드 최소화',
    description: '반복되는 코드를 최소화한 빠른 웹사이트 , 어디서나 반응하는 반응형 웹사이트 ',
  },
  {
    icon: 'logo/logo360x360.png',
    title: '최고의 기업을 향해',
    description: '체계화된 시스템으로 최고의 기업으로 향하는 첫발을 이제 시작합니다.',
  },
];
      ...
      <Container component={MotionViewport}>
        ...
        >
          ...
          <m.div variants={varFade().inDown}>
            <Typography variant="h2">무엇이 달라졌나요 ?</Typography>
          </m.div>
        </Box>
