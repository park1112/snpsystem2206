...
// sections
import InvoiceAnalytic from '../../../sections/@dashboard/release/InvoiceAnalytic';
import { InvoiceTableRow, InvoiceTableToolbar } from '../../../sections/@dashboard/release/list';
...
ReleaseList.getLayout = function getLayout(page) {
...
export default function ReleaseList() {
  ...
  const handleEditRow = (id) => {
    push(PATH_DASHBOARD.release.edit(id));
  };

  const handleViewRow = (id) => {
    push(PATH_DASHBOARD.release.view(id));
  };
  ...
  return (
    <Page title="출고 내역: 출고 목록">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading="출고 내역"
          links={[
            { name: 'Dashboard', href: PATH_DASHBOARD.root },
            { name: '출고', href: PATH_DASHBOARD.release.root },
            { name: '출고 목록' },
          ]}
          action={
            <NextLink href={PATH_DASHBOARD.release.new} passHref>
          ...
          <Scrollbar>
            ...
            >
              <InvoiceAnalytic
                ...
                percent={100}
                price={sumBy(tableData, 'totalCount')}
